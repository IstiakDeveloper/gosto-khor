...
const EditOrganization: React.FC<EditOrganizationProps> = ({ organization }) => {
  ...
  return (
    <OrganizationLayout title="প্রতিষ্ঠানের তথ্য সম্পাদনা">
      <Head title="প্রতিষ্ঠানের তথ্য সম্পাদনা" />
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white shadow overflow-hidden sm:rounded-lg">
          <div className="px-4 py-5 sm:px-6">
            <h3 className="text-lg leading-6 font-medium text-gray-900">প্রতিষ্ঠানের তথ্য সম্পাদনা</h3>
            <p className="mt-1 max-w-2xl text-sm text-gray-500">আপনার প্রতিষ্ঠানের তথ্য আপডেট করুন</p>
          </div>

          <div className="border-t border-gray-200">
            <form onSubmit={handleSubmit} className="p-6">
              <div className="mb-6">
                <label className="block text-sm font-medium text-gray-700">প্রতিষ্ঠানের লোগো</label>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="name" className="block text-sm font-medium text-gray-700">প্রতিষ্ঠানের নাম</label>
                  <input
                    id="name"
                    type="text"
                    value={data.name}
