            ...
            <div className="rounded-md shadow-sm space-y-4">
              <div>
                ...
                <input
                  ...
                  className={`mt-1 appearance-none relative block w-full px-3 py-2 border ${
                    errors.name ? 'border-red-300 text-red-900 placeholder-red-300' : 'border-gray-300 placeholder-gray-500 text-gray-900'
              ...
              <div>
                ...
                <input
                  ...
                  required
                  className={`mt-1 appearance-none relative block w-full px-3 py-2 border ${
                    errors.organization_name ? 'border-red-300 text-red-900 placeholder-red-300' : 'border-gray-300 placeholder-gray-500 text-gray-900'
                  } rounded-md focus:outline-none focus:ring-red-500 focus:border-red-500 focus:z-10 sm:text-sm`}
                ...
                <div className="mt-1 flex rounded-md shadow-sm">
                  <input
                    ...
                    className={`appearance-none relative block w-full px-3 py-2 border ${
                      errors.domain ? 'border-red-300 text-red-900 placeholder-red-300' : 'border-gray-300 placeholder-gray-500 text-gray-900'
              ...
              <div>
                ...
                <select
                  ...
                  className={`mt-1 block w-full py-2 px-3 border ${
                    errors.plan_id ? 'border-red-300 text-red-900' : 'border-gray-300'
